// pme/testing/TestRunner.h — 데이터화된 테스트 시나리오 러너. 설계 문서 §23 (Test Scenario: setup/inputs/run/determinism/assert), §23.1 (assertion 의미론),
...
/// golden 비교: {ok, mismatchedPixels, ratio, error?} 를 돌려준다 (pme::compareCaptures 의 toJson 과 같은 모양)
