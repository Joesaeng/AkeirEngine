// pme/core/Log.h — 구조화 로그. 설계 문서 §28 (OpenTelemetry Logs Data Model 필드, JSON Lines).
//
//   한 줄 = 한 record:
...
#define PME_LOG(level, scope, name, body, ...) \
    ::pme::Logger::global().log(::pme::LogLevel::level, scope, std::string(scope) + "." + name, body __VA_OPT__(,) __VA_ARGS__)
