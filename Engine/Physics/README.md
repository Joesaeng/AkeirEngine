...
- `BodyDesc.layerBits/maskBits` (64-bit) come from `project.json physics.layers` (ADR-0043); Box2D applies the same filter to sensor overlaps. End/SensorEnd events whose shape or body no longer exists are dropped (ADR-0042).
