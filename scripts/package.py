...
"""AKEIR Engine release packager.
    ...
    python scripts/package.py [--preset msvc-release] [--version 0.1.3] [--ref HEAD]
...
def main():
    ...
    ap.add_argument("--version", default="0.1.3")
...
- reference: `cd Game && ..\\bin\\akeir.exe run --headless --ticks 600 --json` → result.finalHash 0xf9a1151e01338658
